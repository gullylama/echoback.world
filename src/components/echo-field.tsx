/*
  ...
  "aurora" (the hero): rendered per-pixel on the GPU by AuroraGlass. CSS
  gradients cannot do either half of it — a continuous iridescent field
  comes out as stripes, and `blur()` is a smear where frosted glass needs
  scattering. See aurora-glass.tsx.
  ...
  field would fight the content sitting on it.
*/

import { AuroraGlass } from "@/components/aurora-glass";
  ...
  return (
    ...
    */
    <div className={`overflow-hidden ${className}`} aria-hidden>
      {aurora ? <AuroraGlass className="absolute inset-0" /> : <Ink />}
